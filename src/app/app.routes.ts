...
export const routes: Routes = [
  ...
  { path: 'shop-settings', loadComponent: () =>
    import('@pages/admin/shop-settings/shop-settings.component').then((m) => m.ShopSettingsComponent), canActivate: [AuthGuard], data: { noPreload: true }},
