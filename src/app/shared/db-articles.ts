...
export const _articles: Array<Article> = [
  {
    imagePath: "assets/photos/articles/snorkelling-gear-on-a-pebble-beach-norfolk-britain-small.webp",
  ...
  {
    imagePath: "assets/photos/articles/children-snorkelling-in-rock-pool-cornwall-britain-small.webp",
    ...
    hidden world of sea dwelling critters that are usually the domain of divers. But snorkelling’s only for warmer climes, right?  \
