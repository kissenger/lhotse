...
@Component({
  ...
  <div class="arrow" [ngClass]="direction=='left'?'left':'right'" >
    <svg [ngClass]="direction=='left'?'left':'right'" viewBox="-5 -5 50 50" height="40px" width="40px" opacity="0.6">
      ...
      <path fill="#1D3D59" d="m0 20a2.6667 2.6667 90 0040 0 2.6667 2.6667 90 00-40 0" pointer-events="none"/>
      <path fill="#1D3D59" stroke="#FFFFFF" stroke-width="4" stroke-linecap="round" d="M16 8 28 20 16 32" pointer-events="none"/>
    </svg>
  </div>
  `,
